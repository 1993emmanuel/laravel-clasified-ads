                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach ($listings as $listing )
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">{{$listing->title}}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">{{$listing->slug}}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                ...
                                                <form method="POST" action="{{ route('listings.destroy',$listing->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a class="text-red-600 hover:text-red-900" href="{{ route('listings.destroy',$listing->id) }}"

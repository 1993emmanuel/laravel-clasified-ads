                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse ($sub_categories as $subcategory )
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">{{$subcategory->name}}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">{{$subcategory->slug}}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                ...
                                                <form method="POST" action="{{ route('admin.subcategories.destroy',$subcategory->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a class="text-red-600 hover:text-red-900" href="{{ route('admin.subcategories.destroy',$subcategory->id) }}"

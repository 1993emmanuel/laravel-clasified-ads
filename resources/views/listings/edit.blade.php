                    ...
                    <form action="{{ route('listings.update',$listing->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    ...
                                    @livewire(
                                        'dependet-edit-category',[
                                            'category'=>$listing->category_id,
                                            'subCategory'=>$listing->sub_category_id,
                                            'childCategory'=>$listing->child_category_id,
                                        ]
                                    )
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <textarea type="text" name="description" id="description"
                                                class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300">{{$listing->description}}</textarea>
                                    ...
                                    <div class="col-span-6 md:col-span-2">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <select name="price_negotiable"
                                                ...
                                                <option 
                                                    {{$listing->price == 'fixed' ? 'selected': ''}}
                                                    value="fixed">
                                                    Fixed
                                                </option>
                                                <option
                                                    {{$listing->price == 'fixed' ? 'negotiable': ''}}
                                                    value="negotiable">
                                                    Negotiable
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-span-6 md:col-span-3">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <input type="number" name="phone_number" id="phone_number"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                placeholder="Phone" value="{{$listing->phone_number}}">
                                    ...
                                    <div class="col-span-6 md:col-span-3">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <select name="is_published"
                                                class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                <option 
                                                    {{$listing->is_published == '0' ? 'selected' : ''}}
                                                    value="0">Unpublished </option>
                                                <option
                                                    {{$listing->is_published == '1' ? 'selected' : ''}} 
                                ...
                                @livewire(
                                    'edit-image-preview',[
                                        ...
                                        'oldImageOne'=>$listing->image_one,
                                        'oldImageTwo'=>$listing->image_two,

...
class ListingController extends Controller
{
    ...
    {   
        ...
        $featured_image = $request->file('featured_image')->store('public/listing');
        $image_one = $request->file('image_one')->store('public/listing');
        $image_two = $request->file('image_two')->store('public/listing');
        $image_three = $request->file('image_three')->store('public/listing');
